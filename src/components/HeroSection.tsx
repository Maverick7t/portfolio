    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-8">
        <motion.h1
          ...
          className="mt-16 font-Playfair bg-gradient-to-br from-blue-600 to-indigo-600 py-4 bg-clip-text text-4xl font-extrabold tracking-tight text-transparent md:text-7xl text-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]"
        >
          Moinaktar Shaikh
        </motion.h1>
