  ...
  const projects = [
    {
      ...
      description: "A comprehensive, end-to-end industry level DevOps project that builds a secure CI/CD pipeline from scratc",
      highlights: [
        "Designed a CI/CD pipeline using Jenkins, SonarQube, Nexus, Docker, and Kubernetes",
        "Integrated Trivy and kube-audit for container and cluster security",
        "Set up monitoring with Prometheus, Grafana, and Blackbox exporter",
        "Automated pipeline alerts and Jira-based notifications",
      ],
    ...
    },
    {
      ...
      description: "CI/CD pipeline to build, test, and deploy containerized apps",
      highlights: [
        "Built CI/CD pipeline on GCP using Cloud Build & Cloud Deploy for GKE deployments",
        "Enabled manual promotion from Dev to Prod with GitHub triggers and Artifact Registry.",
        "Used env-specific Kubernetes YAMLs and Docker image builds", 
      ],
