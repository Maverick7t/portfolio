  ...
  const projects = [
    {
      ...
      description: "A comprehensive, end-to-end industry level DevOps project that builds a secure CI/CD pipeline from scratch",
      highlights: [
        "Designed and deployed a production-grade CI/CD pipeline using Jenkins with multi-stage automation: compile, test,code quality (SonarQube), artifact upload (Nexus), container build (Docker), and Kubernetes deployment.",
        "Integrated Trivy and kube-audit for security scanning of containers and Kubernetes clusters.",
        "Implemented system- and application-level observability using Prometheus, Grafana, and Blackbox exporter; configured alerts and dashboard visualizations.",
        "Built full infrastructure using AWS EC2, VPC, and custom security groups; scripted provisioning of multiple VM instances for SonarQube, Nexus, and Jenkins nodes.",
        "Simulated Jira-based development flow and automated email notifications for pipeline results",
      ],
      technologies: [" Jenkins", "Docker", "SonarQube", "Nexus", "Kubernetes", "AWS"],
      icon: Bot,
      gradient: "from-emerald-500 to-teal-600",
      bgGradient: "from-emerald-500/10 to-teal-600/10",
      link: "https://github.com/Maverick7t/Devops_project"
    },
    {
      id: 2,
      name: "Devops using GCP",
      description: "A fully automated CI/CD pipeline using Google Cloud Build and Cloud Deploy to build, test, and deploy containerized applications to GKE with manual promotion from Dev to Prod environments.",
      highlights: [
        "Built a CI/CD pipeline on Google Cloud using Cloud Build and Cloud Deploy to automate GKE app deployments with manual promotion from Dev to Prod.",
        "Integrated GitHub triggers, Artifact Registry, and Docker image builds with environment-specific Kubernetes YAMLs.",
        "Resolved IAM permission issues and simulated real-world deployment errors to practice incident troubleshooting and release reliability.",
      ],
      technologies: ["GKE", "Cloud Build", "Cloud Deploy", "Artifact Registry", "Docker", "GitHub"],
      icon: Sparkles,
      gradient: "from-purple-500 to-pink-600",
      bgGradient: "from-purple-500/10 to-pink-600/10",
      link: "https://github.com/Maverick7t/Devops_using_GCP"
    }
  ];
